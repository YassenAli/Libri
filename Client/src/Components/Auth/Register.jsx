      ...
      <div class="bg-[#91c8c1] rounded-2xl flex max-w-3xl p-5 items-center">
        <div class="md:w-1/2 px-8">
          ...
          <div class="mt-4 text-sm flex justify-between items-center container-mr">
            ...
            <button class="hover:border register text-white bg-[#20b2aa] hover:border-gray-400 rounded-xl py-2 px-5 hover:scale-110 hover:bg-[#002c7424] font-semibold duration-300" onClick={handlere}>
              Login
            </button>
          </div>
        </div>
