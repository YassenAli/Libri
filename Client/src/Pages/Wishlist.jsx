        ...
        <table className="w-full table-fixed">
            ...
            <tbody className="bg-white">
              <tr>
                ...
                <td className="py-4 px-6 border-b border-gray-200 truncate">On</td>
                <td className="py-4 px-6 border-b border-gray-200">www.box.net</td>
                <td className="py-4 px-6 border-b border-gray-200">
                  <button className="bg-red-500 text-white py-2 px-8 rounded-[5px] text-xs">Ignore</button>
                </td>
              </tr>
              <tr>
                <td className="py-4 px-6 border-b border-gray-200">FR</td>
                <td className="py-4 px-6 border-b border-gray-200 truncate">Off</td>
                <td className="py-4 px-6 border-b border-gray-200">www.frr.com</td>
                <td className="py-4 px-6 border-b border-gray-200">
                <button className="bg-red-500 text-white py-2 px-8 rounded-[5px] text-xs">Ignore</button>
                </td>
              </tr>
