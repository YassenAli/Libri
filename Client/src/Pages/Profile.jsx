...
export default function profile() {
  return (
    <section class="w-full overflow-hidden dark:bg-gray-900 rounded-[26px]">
      <div class="w-full mx-auto bg-[#c5e0dd]">
        ...
        <div class="w-full mx-auto flex justify-center">
          <img
            ...
            alt="User Profile"
            class="rounded-full object-cover xl:w-[10rem] xl:h-[10rem] lg:w-[10rem] lg:h-[16rem] md:w-[12rem] md:h-[12rem] sm:w-[10rem] sm:h-[10rem] xs:w-[8rem] xs:h-[8rem] outline outline-2 outline-offset-2 outline-yellow-500 shadow-xl relative xl:bottom-[7rem] lg:bottom-[8rem] md:bottom-[6rem] sm:bottom-[5rem] xs:bottom-[4.3rem]"
          />
        </div>
