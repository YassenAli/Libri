    ...
    <section className="w-full overflow-hidden dark:bg-gray-900 rounded-[26px]">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="100%">
          ...
          <div class="w-full mx-auto flex justify-center">
            <img src="https://avatar.iran.liara.run/public/20" alt="User Profile"
  class="rounded-full object-cover xl:w-[10rem] xl:h-[10rem] lg:w-[10rem] lg:h-[10rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[6rem] xs:h-[6rem] outline outline-2 outline-offset-2 outline-[#befffc] shadow-xl relative top-[-5rem]" />
        </div>
        <div className="w-full flex gap-4 justify-center items-center ">
          <div className="relative h-[100px] from-indigo-600 via-indigo-700 ">
